  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        >
          <div className="inline-flex items-center justify-center p-1 rounded-2xl bg-gradient-to-br from-secondary/20 to-primary/20 border border-secondary/30 shadow-[0_0_30px_rgba(0,240,255,0.5)] mb-4">
